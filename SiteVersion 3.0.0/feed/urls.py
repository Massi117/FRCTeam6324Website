...
urlpatterns = [
    url('login/', LoginView.as_view(template_name='feed/login.html'), name="login"),
    url('logout/', LogoutView.as_view(template_name='feed/logout.html'), name="logout"),
    url('login/redirect/', LoginView.as_view(template_name='feed/login_redirect.html'), name="login_redirect"),
